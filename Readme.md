...
# Configuration Script – Filling Level Sensor - Rev. A

This **Configuration** script is designed for the **Filling Level Sensor** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Filling Level Sensor Rev. A

Este script de **Configuration** está diseñado para el modelo **Filling Level Sensor** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
